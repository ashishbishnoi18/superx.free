defmodule SuperXWeb do
  ...
  defp html_helpers do
    quote do
      ...
      import Phoenix.HTML
      # Core UI components
      import SuperXWeb.CoreComponents
      import SuperXWeb.PostComponents
  ...
  def verified_routes do
    quote do
      use Phoenix.VerifiedRoutes,
        endpoint: SuperXWeb.Endpoint,
        router: SuperXWeb.Router,
        statics: SuperXWeb.static_paths()
    end
  end
